...
BEGIN
  ...
  INTO v_ads_found, v_upserts, v_blacklist, v_language, v_category, v_duplicate, v_nolanding
...
REVOKE ALL ON FUNCTION public.mining_run_progress(uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.mining_run_progress(uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.mining_run_progress(uuid) TO service_role;